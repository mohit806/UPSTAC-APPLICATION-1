...
class ConsultationControllerTest {
    ...
    public TestRequest createTestRequest() {
        ...
        testRequest.setName("mohit ghansela");
        testRequest.setRequestId(21L);
        testRequest.setCreated(LocalDate.now());
        testRequest.setStatus(RequestStatus.LAB_TEST_COMPLETED);
        testRequest.setAge(22);
        testRequest.setEmail("mghansela24@gmail.com");
        testRequest.setPhoneNumber("9518648875");
        testRequest.setPinCode(247001);
        testRequest.setAddress("Dehradun");
